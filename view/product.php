    ...
    <header class="header">
        ...
        <div class="header-banner">
            <div class="header-banner_content">
                <h2 class="header-banner_heading">Biểu tượng của tình yêu và sự lãng mạn</h2>
            </div>
        </div>
    </header>
    <main class="main">
        <div class="main-info">
            <div class="main-info_left">
                <img src="../content/images/dpflower/sp1.jfif" alt="" class="info-img">
                <div class="info-content">
                    <p class="info-content_text">
                    Hoa sen màu trắng : tượng trưng cho sự tinh khôi, thanh khiết và tịnh tâm trong tâm hồn con người. Ngoài ra, hoa sen trắng còn được biết đến với ý nghĩa chính là sự đức hạnh, bình dị và thanh cao trong tâm hồn phụ nữ.
                    <p class="info-content_text">
                    Hoa sen đỏ : tượng trưng cho tình yêu và sự từ bi, gắn liền với hình ảnh trái tim.
                    </p>
                   
                    <p class="info-content_text">Biểu tượng cho tình yêu trong sáng, thuần khiết: Hoa sen đã trở thành biểu tượng cho tình cảm lứa đôi, tình người với người chứa đựng sự gần gũi và thanh cao.</p>
               
                </div>
            </div>
            <div class="main-info_right">
                <div class="info-right_images">
                    <img src="../content/images/dpflower/sp11.png" alt="" class="info-right_img">
                    <img src="../content/images/dpflower/sp12.png" alt="" class="info-right_img">
                    <a href="#" class="button">Thư viện ảnh</a>
                </div>
                <div class="info-right-price">
                    <div class="price-number">810,000 VND</div>
                    <a href="service.php" class="button">Chọn thêm sản phẩm khác</a>
                </div>
            </div>
        </div>
            ...
            <div class="service">
                <div class="left">
                    <div class="service-order">
                        <h3 class="order-heading">Vui lòng chọn ngày giao hàng và sản phẩm</h3>
