...
<body>
    <header class="header">
        ...
        <div class="header-banner">
            <div class="header-banner_content">
                <h2 class="header-banner_heading">THƯ VIỆN</h2>
            </div>
        </div>
    </header>
    ...
    <div class="container-libary">
        <div class="libary-child">
            <img src="../content/images/libary1.png" alt="">
        </div>
        <div class="libary-child">
            <img src="../content/images/libary2.png" alt="">
        </div>
        <div class="libary-child">
            <img src="../content/images/libary3.png" alt="">
        </div>
        <div class="libary-child">
            <img src="../content/images/libary4.png" alt="">
        </div>
        <div class="libary-child">
            <img src="../content/images/libary5.png" alt="">
        </div>
        <div class="libary-child">
            <img src="../content/images/libary6.png" alt="">
        </div>
        <div class="libary-child">
            <img src="../content/images/libary7.png" alt="">
        </div>
        <div class="libary-child">
            <img src="../content/images/libary8.png" alt="">
        </div>
    </div>
